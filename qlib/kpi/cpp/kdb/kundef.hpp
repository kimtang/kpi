...
# undef kx_KJ // 8 long     int64  kJ
# undef kx_KE // 4 real     float  kE
# undef kx_KF // 8 float    double kF
# undef kx_KC // 1 char     char   kC
# undef kx_KS // * symbol   char*  kS
# undef kx_KP // 8 timestampint64  kJ (nanoseconds from 2000.01.01)
# undef kx_KM // 4 month    int    kI
# undef kx_KD // 4 date     int    kI (days from 2000.01.01)
# undef kx_KZ // 8 datetime double kF (days from 2000.01.01)
# undef kx_KN // 8 timespan int64  kJ
