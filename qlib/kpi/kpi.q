...
.kpi.lib.def:update fname:`${"." sv string x}'[flip(repo;nsp;orig)] from update repo:`${".",1_first "_" vs x}@'name,nsp:`${first 1_"_" vs x}@'name,name:`${"_" sv  2_"_" vs x}@'name,orig:`$name from {select from x where not null num} flip`name`num!("*j";";") 0: read0 .kpi.lib.defPath
